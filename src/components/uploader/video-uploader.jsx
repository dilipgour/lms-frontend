...
import { Button as SadcnButton } from "@/components/ui/button";
...
const VideoUploader = React.forwardRef(
  (
    { dropzoneOptions, width, height, value, className, disabled, onChange,onUpload,isLoading },
    ref
  ) => {
        ...
        >
          ...
          {videoUrl ? (
            ...
            <div className="h-40 w-40 flex justify-center items-center">
               <SadcnButton onClick={onUpload}>{!isLoading?"upload video": <Loader2 className="animate-spin h-2 w-2"/>} </SadcnButton>
            </div>
